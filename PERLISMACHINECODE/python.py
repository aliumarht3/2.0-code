...
if not tared:
    print("?? [STARTUP] No TARED reply ? continuing anyway.")
with uno_lock:
...
def on_close():
    ...
    # Safely start the reconnect loop in a background thread so it doesn't freeze the machine!
