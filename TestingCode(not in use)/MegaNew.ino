...
void loop() {
  ...
  while (Serial.available()) {
    ...
    // -------------------------------
      ...
      Serial.println("ACK:TEST_PUMP_ON");
    }
    else if (command == "TEST_PUMP_OFF") {
      digitalWrite(PUMP_RELAY, LOW);
      Serial.println("ACK:TEST_PUMP_OFF");
    }
    ...
    // -------------------------------
      ...
      Serial.println("ACK:TEST_VALVE_ON");
    }
    else if (command == "TEST_VALVE_OFF") {
      digitalWrite(PUMP_GPIO2, LOW);
      Serial.println("ACK:TEST_VALVE_OFF");
    }
    ...
    // Lock / Stop Commands
      ...
      digitalWrite(PUMP_RELAY, LOW);
      Serial.println("excess_pump_stopped");
    }
